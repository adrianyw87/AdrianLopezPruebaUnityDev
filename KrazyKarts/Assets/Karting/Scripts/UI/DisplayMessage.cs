...
public class DisplayMessage : MonoBehaviour
{
    ...
    public void Display()
    {
        ...
        //Adrian: informar al jugador del tiempo de vuelta que debe superar
        float historicalBestLapTime = PlayerPrefs.GetFloat("bestLap_historical");
        message = historicalBestLapTime == 0 ? message : $"{message}  ({historicalBestLapTime})";
